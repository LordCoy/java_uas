...
public class Uas {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/uas_java";
    ...
    private static void create(Statement eksekusi, Scanner input) throws SQLException {
        ...
        System.out.print("Masukan category ( 1. Sport || 2. Casual || 3. Riding): ");
        ...
        if (category == 1 || category == 2 || category == 3) {
            ...
            String sql = "INSERT INTO product (id, id_category, name, desc, price, status) VALUES ('" + id
    ...
    private static void edit(Statement eksekusi, Scanner input) throws SQLException {
        ...
        if (category == 1 || category == 2 || category == 3) {
            ...
            String sql = "UPDATE product SET id_category = '" + category + "', desc = '" + des + "', price = '"
